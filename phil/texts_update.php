...
$scat=mysql_result($result,$i,"scat");
$title=mysql_result($result,$i,"title");
$intro=mysql_result($result,$i,"intro");
$text=mysql_result($result,$i,"text");
$image=mysql_result($result,$i,"image");
$link=mysql_result($result,$i,"link");
$s_section=mysql_result($result,$i,"s_section");
...
?>		
		...
		Title:<input type="text" name="ud_title" size="55" value="<? echo($title);?>"><br>
		Image:<input type="text" name="ud_image" size="55" value="<? echo ($image);?>"><br>
		Link:<input type="text" name="ud_link" size="55" value="<? echo ($link);?>"><br>
		Subsection:<select name="ud_s_section" size="1">
			<?
			if ($scat==1 or $scat==2) {
				echo "<option value='$s_section' selected>No Subsections</option>";
			}	
			if ($scat==3) {
				?>
				<option value="1" <? if (s_section==1) { echo"selected"; }?>>Text</option>
				<option value="2" <? if (s_section==2) { echo"selected"; }?>>Press Releases</option>
				<option value="3" <? if (s_section==3) { echo"selected"; }?>>Quoted</option>
				<option value="4" <? if (s_section==4) { echo"selected"; }?>>Published photos</option>
				<?
			}			
			?>	
		</select><br>
		Intro:<br> <textarea cols="67" rows="5" name="ud_intro" value=""><? echo($intro);?></textarea><br>
