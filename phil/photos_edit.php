...
?>
		...
		// Small loop starts here
 		...
 		?>
			...
			if ($cur<=$total) {
   			?>
    			<td width="102" height="67" align="center" bgcolor="#000000"><a href="photos_big_edit.php?cat=<?php echo $cat; ?>&photo=<?php echo $cur; ?>"><img src="updates/photos/s<?php echo $cat; ?>/thumbs_<?php echo $cur; ?>.jpg" width="100" height="65" border="0"></a></td>
   				<?php
				} else {
   				?>
    			<td>&nbsp;</td>
