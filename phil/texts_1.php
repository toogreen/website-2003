...
if ($edit==$editvar) {
?>		
		<span class='blog_titre'>Add a new text entry | <a href="texts_1.php?scat=1">Exit EDIT mode</a></span>
...
<!-- begin Nedstat Pro 4.0 code --><img src="http://fr.nedstatpro.net/cgi-bin/nedstatpro.gif?name=photojou_4" width=1 height=1 align=right><!-- end Nedstat Pro 4.0 code -->
</body>
</html>
