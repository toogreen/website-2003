...
<table border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="1" valign="top"> <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tr> 
          <td><a href="#" onMouseOver="MM_swapImage('swap','','images/img_bswap_f2.jpg','swaptitle','','images/img_big_title_2.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="images/img_button_2.gif" name="img_b2" width="135" height="37" border="0"></a></td>
        </tr>
        <tr> 
          <td><a href="#" onMouseOver="MM_swapImage('swap','','images/img_bswap_f3.jpg','swaptitle','','images/img_big_title_3.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="images/img_button_3.gif" name="img_b3" width="135" height="37" border="0"></a></td>
        </tr>
        <tr> 
          <td><a href="#" onMouseOver="MM_swapImage('swap','','images/img_bswap_f4.jpg','swaptitle','','images/img_big_title_4.gif',1)" onMouseOut="MM_swapImgRestore()"><img src="images/img_button_4.gif" name="img_b4" width="135" height="37" border="0"></a></td>
        </tr>
        <tr> 
              ...
              <tr> 
				...
				if ($photo<=1) {
                  ...
                  <?php
   					...
   					?>
                  <a href="photos_big_edit.php?cat=<?php echo $cat; ?>&photo=<?php $prev=$photo-1; echo $prev; ?>"><img src="images/img_fleche1.gif" width="18" height="16" border="0"></a>	
                  <?php
			}
			?>
                </td>
				...
				if ($photo<$total) {
   				?>
                  <a href="photos_big_edit.php?cat=<?php echo $cat; ?>&photo=<?php $next=$photo+1; echo $next; ?>"><img src="images/img_fleche2.gif" width="18" height="16" border="0"></a> 
                  <?php
					} else {
   					?>
                  <img src="images/spacer.gif" width="18" height="16" border="0"> 
...
Commentaires: <textarea cols="65" rows="5" name="comment" value="">No comments inserted yet</textarea><br>
<input type="Submit">
</form>
<?
}else{ 
...
Commentaires: <textarea cols="65" rows="5" name="ud_comment" value="<? echo($comment);?>"><? echo($comment);?></textarea><br>
