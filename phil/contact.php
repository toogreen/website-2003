...
<table border="0" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td align="left" valign="top"> <table width="100%" border="0" cellpadding="0" cellspacing="0" background="images/img_text_bg.jpg">
        <tr bgcolor="#000000"> 
          <td colspan="2" bgcolor="#000000"><img src="images/img_big_title_5.gif" name="swaptitle" width="200" height="39" id="swaptitle"><img src="images/img_stitle_swap.gif" name="swapstitle" width="110" height="39" id="swapstitle"></td>
        ...
        <tr> 
          ...
          <td>
            <?php include("updates/texts/text_contact.html"); ?>
			</td>
        </tr>
      </table>
